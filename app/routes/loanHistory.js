...
// async function getLoanHistory(request, resolve) {
//   const config = await dictionary('loanHistory');
//   try {
//     const loanHistory = await db.loanHistory.findAll({
//       where: {
//         [config.loanHistory]: 1,
//       },
//       rejectOnEmpty: true,
//     });
//     return resolve
